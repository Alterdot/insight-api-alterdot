...
GovObjectController.prototype.submit = function (req, res) {
  ...
  this.node.services.alterdotd.govObjectSubmit(parentHash, revision, time, dataHex, feeTxId, function(err, result) {
...
GovObjectController.prototype.govObjectList = function(options, callback) {
    this.node.services.alterdotd.govObjectList(options, function(err, result) {
        if (err) {
            return callback(err);
        }
...
GovObjectController.prototype.getHash = function(hash, callback) {
    ...
    this.node.services.alterdotd.govObjectHash(hash, function(err, result) {
        if (err) {
            return callback(err);
        }
...
GovObjectController.prototype.govObjectCheck = function(req, res) {
  ...
  this.node.services.alterdotd.govObjectCheck(hexdata, function(err, result) {
    if (err) {
      return self.common.handleErrors(err, res);
    }
    res.jsonp(result);
...
GovObjectController.prototype.getInfo = function (req, res) {
  var self = this;
  this.node.services.alterdotd.govObjectInfo(function (err, result) {
    if(err) { return self.common.handleErrors(err, res);}
    res.jsonp(result);
  })
}
...
GovObjectController.prototype.getCount = function (req, res) {
  var self = this;
  this.node.services.alterdotd.govCount(function (err, result) {
    if(err) { return self.common.handleErrors(err, res);}
    res.jsonp(result);
  })
}
...
GovObjectController.prototype.govObjectVotes = function (req, res) {
  ...
  this.node.services.alterdotd.getVotes(govHash, function (err, result) {
    if(err) { return self.common.handleErrors(err, res);}
    res.jsonp(result);
  })
}
...
GovObjectController.prototype.govObjectCurrentVotes = function (req, res) {
  ...
  this.node.services.alterdotd.getCurrentVotes(govHash, function (err, result) {
    if(err) { return self.common.handleErrors(err, res);}
    res.jsonp(result);
  })
}
...
GovObjectController.prototype.govObjectDeserialize = function (req, res) {
  ...
  this.node.services.alterdotd.govObjectDeserialize(hexdata, function (err, result) {
    if(err) { return self.common.handleErrors(err, res);}
    res.jsonp(result);
  })
}
